...
public class HomeFragment extends Fragment {
    ...
    private void initServiceList() {
        ...
        binding.homeServiceList.serviceFilm.setOnClickListener(v -> {
            NavController navController = Navigation.findNavController(requireActivity(), R.id.fragment_main);
            navController.navigate(R.id.action_navControlFragment_to_filmFragment);
        });
        ...
        binding.homeServiceList.serviceLivingExpenses.setOnClickListener(v -> {
            NavController navController = Navigation.findNavController(requireActivity(), R.id.fragment_main);
            navController.navigate(R.id.action_navControlFragment_to_livingExpensesFragment);
        });
        ...
        binding.homeServiceList.serviceOutpatientAppointment.setOnClickListener(v -> {
            NavController controller = Navigation.findNavController(requireActivity(), R.id.fragment_main);
