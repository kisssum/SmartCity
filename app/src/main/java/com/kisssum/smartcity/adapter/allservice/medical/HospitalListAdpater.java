...
public class HospitalListAdpater extends RecyclerView.Adapter<HospitalListAdpater.DefaultViewModel> {
    ...
    public HospitalListAdpater(Context context) {
    ...
    public DefaultViewModel onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_style_hospital, parent, false);
    ...
    public void onBindViewHolder(@NonNull @NotNull DefaultViewModel holder, int position) {
        ...
        try {
            holder.hName.setText(object.getString("hospitalName"));
            ...
            holder.hUrl.setText(object.getString("url"));
    ...
    static class DefaultViewModel extends RecyclerView.ViewHolder {
        ...
        public DefaultViewModel(@NonNull View itemView) {
            ...
            hText = itemView.findViewById(R.id.hospitalText);
            hImg = itemView.findViewById(R.id.hospitalPic);
            hUrl = itemView.findViewById(R.id.hospitalUrl);
        }
    }
    ...
    public void loadData(boolean up) {
        ...
        String url = "http://" + sp.getString("ip", "") + ":" + sp.getString("duankou", "") + "/SmartCitySrv/hospital/hospitalList/";
